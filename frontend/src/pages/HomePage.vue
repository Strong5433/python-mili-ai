  ...
  <div id="homePage">
    <div class="container">
      ...
      <div class="hero-section">
        <h1 class="hero-title">AI应用开发助手</h1>
        <p class="hero-description">让创意，即刻成为应用</p>
      </div>
...
#homePage::before {
  ...
  background:
    /* 柔光云雾 */
    radial-gradient(circle at 20% 30%, rgba(255,255,255,0.45) 0%, transparent 22%),
    radial-gradient(circle at 75% 20%, rgba(255,255,255,0.35) 0%, transparent 18%),
    radial-gradient(circle at 60% 75%, rgba(255,255,255,0.28) 0%, transparent 24%),

    /* 蓝色光晕 */
    radial-gradient(circle at 15% 80%, rgba(125, 211, 252, 0.18) 0%, transparent 28%),
    radial-gradient(circle at 85% 65%, rgba(96, 165, 250, 0.16) 0%, transparent 30%),
  ...
  /* 动态浮动 */
  animation: skyFlow 18s ease-in-out infinite alternate;
}
